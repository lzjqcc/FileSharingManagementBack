$.fn.sider = function(q) {
    ...
    $.extend(a, q);
    $(this).html('<input type="text" name="' + a.name + '" value="' + a.value + '" class="form-control"><div class="popcontent"><ul></ul><div class="sider"><div class="sider-btn"></div></div></div>');
    ...
    k.focus(function(b) {
        ...
        for (i in a.quick)
            b += "<li data-num='" + a.quick[i] + "' style='width:" + h + "%'></li>";
        c.html($(b));
        f = p.width() - l.width();
        t = f / u;
